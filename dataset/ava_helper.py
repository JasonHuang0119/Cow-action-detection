...
FPS = 30
# AVA_VALID_FRAMES 這個是對應 Val.csv 中第二欄為 frame_id (第1到第17second的)
AVA_VALID_FRAMES = range(2, 15)
...
def load_boxes_and_labels(gt_box_list, exclusion_file, is_train=False, full_test_on_val=False):
    ...
    with open(ann_filename, 'r') as f:
        for line in f:
            ...
            if not is_train and not full_test_on_val and frame_sec % 1 != 0: #原本是 %4 目的是為了在訓練的時候只要每隔4筆資料測試資料才拿來做驗證,速度比較快
                continue
