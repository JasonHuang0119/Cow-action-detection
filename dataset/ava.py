...
# 71 與 72 行,我有拿來看輸出的bbox與labels個數是否與 img 的數量對齊,訓練的圖片要與標記的數量對上(就是每張圖都需要標記)
# Dataset for AVA
class AVA_Dataset(Dataset):
    def __init__(self,
                 ...
                 img_size=224,
                 transform=None,
                 len_clip=16, # 一次抓取 16 frames (sliding windows)
                 sampling_rate=1):
        self.num_classes = 10
    ...
    def _load_data(self):
        ...
        print("boxes_and_labels",len(boxes_and_labels))
...
if __name__ == '__main__':
    ...
    sampling_rate = 1
    dataset_config = {
        'data_root': '/home/jason/YOWOv2/dataset/AVA_Dataset',
        'frames_dir': 'frames/',
