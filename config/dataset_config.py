...
dataset_config = {
    'ucf24': {
        # dataset
        'gt_folder': '/home/jason/YOWOv2_cow/evaluator/groundtruths_ucf_jhmdb/groundtruths_ucf/',
        # input size
        'train_size': 224,
        'test_size': 224,
        # transform
    ...
    'ava_v2.2':{
        ...
        'train_gt_box_list': 'ava_v2.2_cow/ava_train_v2.2.csv',
        'val_gt_box_list': 'ava_v2.2_cow/ava_val_v2.2.csv',
        'train_exclusion_file': 'ava_v2.2_cow/ava_train_excluded_timestamps_v2.2.csv',
        'val_exclusion_file': 'ava_v2.2_cow/ava_val_excluded_timestamps_v2.2.csv',
        'labelmap_file': 'ava_v2.2_cow/ava_action_list_v2.2.pbtxt', #'ava_v2.2_cow/ava_action_list_v2.2_for_activitynet_2019.pbtxt', 
        'class_ratio_file': 'config/ava_categories_ratio.json', #  no use this file
        'backup_dir': 'results/',
        # input size
        #'train_size': 224,
        'train_size': 224,
        ...
        'wp_iter': 500,
        # class names
        'valid_num_classes': 10,
        'label_map': (
                    'Lying', 'Lying ruminating', 'Walking', 'Playing', 'Approaching', 'Repelling', 'Chasing mounting', 'Feeding', 'Standing ruminating', 'Idling'
                    # 'walk', 'stand', 'l
                    # ie down' , 'eat' , 'drink' , 'on heat'
