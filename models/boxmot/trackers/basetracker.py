...
class BaseTracker(object):
    ...
    def plot_box_on_img(self, img: np.ndarray, box: tuple, conf: float, cls: list, id: int) -> np.ndarray:
        """
        ...
        thickness = 2
        fontscale = 0.5
        # Convert class list to a comm-separated sting
        ...
        img = cv.putText(
            img,
            f'id: {int(id)}, conf: {conf:.2f}, c: {cls_str}',
