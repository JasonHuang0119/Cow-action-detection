...
class ResNeXt(nn.Module):
    ...
    def __init__(self,
        ...
        # self.nonlocal1 = NonLocalBlock3D(256)
        # self.nonlocal2 = NonLocalBlock3D(512)
        self.nonlocal3 = NonLocalBlock3D(1024)
        self.nonlocal4 = NonLocalBlock3D(2048)
    ...
    def forward(self, x):
        ...
        c2 = self.layer1(c2)
        #c2 = self.nonlocal1(c2)
        c3 = self.layer2(c2)
        #c3 = self.nonlocal2(c3)
        c4 = self.layer3(c3)
        c4 = self.nonlocal3(c4)
        c5 = self.layer4(c4)
        c5 = self.nonlocal4(c5)

        if c5.size(2) > 1:
            c5 = torch.mean(c5, dim=2, keepdim=True)
        #print('c5 Size:',c5.squeeze(2).size())
        return c5.squeeze(2)
