...
class SlowFast(nn.Module):
    def __init__(self, block=Bottleneck, layers=[3, 4, 6, 3], class_num=10, dropout=0.5 ,use_triplet_attention = False):
        ...
        if use_triplet_attention:
            self.triplet_attention_slow2 = TripletAttention(256)
            self.triplet_attention_slow3 = TripletAttention(512)
            self.triplet_attention_slow4 = TripletAttention(1024)
        else:
            self.triplet_attention_slow2 = None
