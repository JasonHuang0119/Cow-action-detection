...
class Criterion(object):
    def __init__(self, args, img_size, num_classes=6, multi_hot=False):
    ...
    def __call__(self, outputs, targets):        
        ...
        #print("fg_masks",fg_masks) False or True
        ...
        #print("matched_cls",matched_cls_preds,matched_cls_preds.shape)
